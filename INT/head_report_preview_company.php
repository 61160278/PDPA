        ...
        <?php
            if($row_home["data_report_type"] == 1){
                ...
                $sql_publicTable = "SELECT * From data_department_report AS depar
                                    ...
                                    ON map.Department_id = depar.data_department_report
                                    WHERE depar.data_department_data_report_id = ".$_GET["id"]."";
                    ...
                    <div class="ibox-content">
                        ...
                        <div id="modal_simple" class="modal fade" tabindex="-1" role="dialog">
                            <form id="ow" name="ow" method="POST"
                                action="../ENG/update_report.php?id=<?php echo $_GET["id"]?>">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <input type="text" name="boroow_ID"
                                                value="<?php echo $row_emp ["data_report_id"] ?>" hidden>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal">Close</button>
                                            <button type="submit" name="button" value="5"
