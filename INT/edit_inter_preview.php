...
<body>
    <div id="wrapper">
        ...
        <?php 
			...
			while($row_homeTable = mysqli_fetch_array($result_homeTable)){
                $scd_id[$row]=$row_homeTable['scd_id'];
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <form id="ow" name="ow" method="POST" action="../ENG/update_user.php?id=<?php echo $_GET["id"]?>">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-3 b-r">
                                <div class="form-group"><label class="font-noraml">ประเทศ | Country</label><textarea type="text" name="country" 
                                    class="form-control" rows="3" required><? echo $row_home['emp_trv_country']?></textarea>
                                </div>
                            </div>
                            <div class="col-sm-3 b-r">
                                <div class="form-group"><label class="font-noraml">เดินทางไป | Travel to</label><textarea type="text" name="travel_to" 
                                    class="form-control" rows="3" required><? echo $row_home["emp_trv_to"]?></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6 b-r">
                                <div class="form-group"><label class="font-noraml">วัตถุประสงค์*คำอธิบายรายละเอียด | Purpose*Describe detail</label><textarea class="form-control" name="purpose" 
                                    class="form-control" rows="3" required><?echo $row_home["emp_trv_purpose"]?></textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th colspan="2" style="text-align:center">
                                                    ...
                                                    class="form-control" size="1" value="<? echo $row_home["emp_trv_duration"]?>" required></label>&nbsp;days 
                                                        <br>ระยะเวลา (บิน)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;วัน
                                                </th>
                                                <th colspan="2" style="text-align:center">
                                                ...
                                                <th colspan="2" class="form-group">
                                                    <center><label class="col-sm-7 control-label">Schedule
                                                        ...
                                                        <div class="col-sm-3">
                                                            <select class="form-control" style="width:130px" tabindex="2" name="data_item1">
                                                                <?php
									                            ...
									                            ?>
                                                                <option value ="<?php echo $row_Travel_Type["trv_id"];?>"<?php if($row_Travel_Type["trv_id"]==$row_home["emp_trv_trv_id"]){echo "selected=selected";}?>><?php echo $row_Travel_Type["trv_name"]; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                </th>
                                        ...
                                        <tbody>
                                            <tr align="center">
                                                ...
                                                <td align="left">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="date_d" class="form-control" value="<?php echo $row_home["emp_trv_date_go_flight"]?>" required>
                                                    </div>
                                                </td>
                                                <td align="left">
                                                    <div class="form-group"><label class="font-noraml">Time | เวลาเดินทางไป</label>
                                                        <div class="input-group time"><input type="time" name="time_d" class="form-control" value="<?php echo $row_home["emp_trv_time_go_flight"]?>" required>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td align="left">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="date_depart" class="form-control" value="<?php echo $row_home["emp_trv_date_go_schedule"]?>" required> 
                                                    </div>
                                                </td>
                                                <td align="left">
                                                    <div class="form-group"><label class="font-noraml">Time | เวลาเดินทางไป</label>
                                                    <div class="input-group time">
                                                        <input type="time" name="time_depart" class="form-control" value="<?php echo $row_home["emp_trv_time_go_schedule"]?>" required>
                                                    </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr align="center">
                                                ...
                                                <td align="left">
                                                    <div class="form-group">
                                                        <label class="font-noraml" class="input-group-addon">Date | วันเดินทางกลับ</label>
                                                        <input type="date" name="date_r" class="form-control" value="<?php echo $row_home["emp_trv_date_return_flight"]?>" required>
                                                    </div>
                                                </td>
                                                <td align="left">
                                                    <div class="form-group"><label class="font-noraml">Time | เวลาเดินทางกลับ</label>
                                                        <div class="input-group time"><input type="time" name="time_r" class="form-control" value="<?php echo $row_home["emp_trv_time_return_flight"]?>" required>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td align="left">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="date_return" class="form-control" value="<?php echo $row_home["emp_trv_date_return_schedule"]?>" required>
                                                    </div>
                                                </td>
                                                <td align="left">
                                                    <div class="form-group"><label class="font-noraml">Time | เวลาเดินทางกลับ</label>
                                                        <div class="input-group time"><input type="time" name="time_return" class="form-control" value="<?php echo $row_home["emp_trv_time_return_schedule"]?>" required>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="6" class="form-group">
                                                    <div class="form-group"><label class="col-sm-2 control-label">Private schedule :<br>กิจส่วนตัว</label>
                                                        <div class="col-sm-6">
                                                            <select class="form-control" style="width:500px" tabindex="2" name="data_item2" >
                                                                <?php
									                            ...
									                            ?>
                                                                <option value ="<?php echo $row_Business_Type["bsn_id"];?>"<?php if($row_Business_Type["bsn_id"]==$row_home["emp_trv_bsn_id"]){echo "selected=selected";}?>><?php echo $row_Business_Type["bsn_name"]; ?></option>
                                                                <? } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                        ...
                        <h3><span class="badge">
                            <font size="4px" color="black"><b>Schedule of International Travel | ตารางการเดินทางระหว่างประเทศ</b>
                            </span></font>
                        </h3>
                        <br>
                        <div class="row">
                                            ...
                                            <tr id="firstTr">
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <input type="text" hidden style="width:160px" name="scd_id[]"
                                                            value="<?php echo $scd_id[$i]?>" >

                                                        <input type="date" class="form-control" style="width:160px" name="data2[]"
                                                            value="<?php echo $array[$i]?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <select class="form-control" style="width:80px" name="data3[]">
                                                        <?php
								                        ...
								                        ?>
                                                            <option value ="<?php echo $row_Calendar_Type["cld_id"];?>"<?php if($row_Calendar_Type["cld_id"]==$array2[$i]){echo "selected=selected";}?>><?php echo $row_Calendar_Type["cld_name"]; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </td>
                                                <td>
                                                    <textarea type="text" name="data4[]" class="form-control" rows="2" required><?php echo $array3[$i]?></textarea></td>
                                                <td>
                                                    <textarea type="text" name="data5[]" class="form-control" rows="4" required><?php echo $array4[$i]?></textarea></td>
                                                <td>
                                                <select class="form-control" style="width:155px" name="data6[]">
                                                    <?php
                                                ...
                                                <td>
                                                    <textarea type="text" name="data8[]" class="form-control" rows="2" required><?php echo $array6[$i]?></textarea>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                        ...
                        <h3><span class="badge">
                            <font size="4px" color="black"><b>Expense Approve | การอนุมัติค่าใช้จ่าย</b>
                            </span></font>
                        </h3>
                        <br>
                        <div class="row">
                                        ...
                                        <div class="col-sm-2">Payment | ค่าตอบแทน</div>
                                            <div class="col-sm-4">
                                                <select class="form-control" name="data_item3">
                                                    ...
                                                    ?>
                                                        <option value ="<?php echo $row_Withdraw_Type["wid_id"];?>"<?php if($row_Withdraw_Type["wid_id"]==$row_home["emp_trv_wid_id"]){echo "selected=selected";}?>><?php echo $row_Withdraw_Type["wid_name"]; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                    </td>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr align="center">
                                                ...
                                                <td>
													<select class="select2_demo_1 form-control" name="mgr" id="mgr" style="width:100%;" tabindex="2" >
														<option hidden value="<?php echo $row_home["emp_trv_check"]?>" ><?php echo $row_home["emp_trv_check"]?></option>
														<?php
                                                ...
                                                <td>
													<select class="select2_demo_1 form-control" name="acknow" id="acknow" style="width:100%;" tabindex="2">
													<option hidden value="<?php echo $row_home["emp_trv_acknowledge"]?>" ><?php echo $row_home["emp_trv_acknowledge"]?></option>
                                                    <?php
                                                        $sql_Approve = "SELECT * From employee";
                                                        $result_Approve = mysqli_query($condbmc, $sql_Approve);
                                                        while($row_Approve = mysqli_fetch_array($result_Approve)){
                                                ...
                                                <td>
													<select class="select2_demo_1 form-control" name="approve" id="approve" style="width:100%;" tabindex="2">
													<option hidden value="<?php echo $row_home["emp_trv_approve"]?>" ><?php echo $row_home["emp_trv_approve"]?></option>
                                                    <?php
                                                        $sql_Approve = "SELECT * From employee";
                                                        $result_Approve = mysqli_query($condbmc, $sql_Approve);
                                                        while($row_Approve = mysqli_fetch_array($result_Approve)){
    ...
    $(function() {
        ...
        $("#addRow").click(function() {
            ...
            tr += '<input type="date" class="form-control" style="width:160px" name="data2[]">'
            tr += '</div>'
            tr += '</td>'
            tr += '<td>'
