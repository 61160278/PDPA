    ...
    <div id="wrapper">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
			  ...
			  <form class="form-login" name="form1" method="post" action="../ENG/signup_check.php" OnSubmit="return fncSubmit();">
				...
				<p></p>				
				<center><b>ลงทะเบียนเข้าใช้งาน</b></center>
				...
				<p></p>
				<b>รหัสผ่าน | New Password</b>&nbsp;(More Than 8 digit)
					<div class="input-group">
						<span class="input-group-addon">
				...
				<p></p>
				<b>ยืนยันรหัสผ่าน | Confirm Password</b>
					<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-lock"></i>&nbsp;
						</span>
		            ...
		            <p>&nbsp;</p>
		            <button class="btn btn-theme02 btn-block" type="submit" name="Submit" value="Save"><i class="fa fa-key"></i> SIGN UP</button>
        ...
        <div id="page-content-wrapper">
			...
			<a class="" href="../index.php">
                ...
                <a href="#menu-toggle" class="btn btn-theme02" id="menu-toggle">ลงทะเบียน | Register</a>
            </div>
        </div>
