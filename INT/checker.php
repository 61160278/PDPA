        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom"><?php include "top-bar.php";?></div>
                <div class="row  border-bottom white-bg dashboard-header">
                    <div class="col-sm-12">
                        <h2><center><b>รายงานการตรวจสอบ | Inspection Report</b></center></h2>
                    </div>
                    <br>
                    <div class="col-sm-12">
                        <br>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center"><a href ="checker_approve.php?id=<?php echo $row_approve["emp_trv_id"] ?>"><button class="btn btn-outline btn-info " type="button"><i class="fa fa-search"></i></button></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
