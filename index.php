            ...
            <ul class="sidebar-nav">
                ...
                <div id="page-content-wrapper">
                    <div class="container-fluid">
                            ...
                            <h1 align="center">
                                <font color="#393939" ><b>PDPA | DENSO</b></font>
                            </h1>
                            <p align="center">
                                <font color="#393939">
                                    ระบบแบบฟอร์มร้องขอข้อมูลส่วนบุคคลของพนักงานออนไลน์ที่ใช้งานผ่านเว็บไซด์ในระบบเครือข่ายอินเทอร์เน็ต
                                </font>
                            </p>
                    </div>
                </div>
                ...
                <form class="form-login" name="form1" method="post" action="ENG/logincheck.php">
                    <h2 class="form-login-heading"><b>login</b>
                        <font color="#BE4F0C "><b> to your</b></font><br>
                        <small>
                            <font color="#ffffff">PDPA</font>
                            <font color="#BE4F0C "><b> Account</b></font>
                        </small>
                    </h2>
                    ...
                    <div class="login-wrap">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="empid" id="empid" placeholder="Employee ID"
                                pattern=".{5,}" title="กรุณากรอกรหัสพนักงาน 5 ตัว" required />
                        </div>
                        <p></p>
                        <br>
                        <p>&nbsp;</p>
                        <button class="btn btn-theme02 btn-block" type="submit" name="Submit" value="Save"><i
                                class="fa fa-key"></i> Submit</button>

                        <br>
                        <div class="centered">
                            <a class="bg-chet" href="../index.php">
                                <i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp; กลับหน้าหลัก | Back to main
                                menu
                            </a>
                        </div>
                    </div>
