...
if(l.queryCommandSupported("copy")){d.appendTo(b.table().container());c[0].focus();c[0].select();try{var k=l.execCommand("copy");d.remove();if(k){b.buttons.info(b.i18n("buttons.copyTitle","คัดลอกไปที่คลิปบอร์ด"),b.i18n("buttons.copySuccess",{1:"Copied one row to clipboard",_:"คัดลอก %d แถวไปยังคลิปบอร์ด"},a.rows),2E3);this.processing(!1);return}}catch(o){}}k=e("<span>"+b.i18n("buttons.copyKeys","Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.")+
